# VIETLAW - Kho Dữ Liệu Pháp Luật Việt Nam cho AI/RAG

> Hệ thống Luật pháp Việt Nam đầy đủ, được cấu trúc hóa cho RAG (Retrieval-Augmented Generation) và các ứng dụng AI.

## Giới thiệu

**VIETLAW** là kho dữ liệu pháp luật Việt Nam được thiết kế đặc biệt cho các hệ thống AI/RAG. Dữ liệu được tổ chức theo cấu trúc markdown có metadata YAML frontmatter, tối ưu hóa cho việc chunking, embedding và truy xuất thông tin pháp lý.
...
rag = VietlawRAG(index_path="index/", model="claude-opus-4-6")
...
| Luật chuyên ngành | 17 | DN, Đầu tư, Đất đai, Thương mại, Nhà ở, Thuế (TNCN/GTGT/TNDN), SHTT, ANM, HNGĐ, BVMT, Giáo dục, Cán bộ CC, PCTN, Khiếu nại, Tố cáo |
| Luật 2024 | 8 | BHXH, Căn cước, Công đoàn, GDĐT, KD BĐS, ATGT, Điện lực, Đầu tư công |
| **Luật 2025** | **50** | Trí tuệ nhân tạo, Bảo vệ DLCN, Thuế TNCN/TNDN/TTĐB sửa đổi, An ninh mạng 2025, Chuyển đổi số, TMĐT, DN sửa đổi, Đầu tư 2025, Nhà giáo, Việc làm, CQĐP, Báo chí, PCTN sửa đổi, và nhiều luật khác |
| Nghị định | 4 | NĐ 145/2020 (Lao động), NĐ 01/2021 (ĐKDN), NĐ 100/2019 (cũ), NĐ 168/2024 (Xử phạt GT mới) |
